...
public class SampleDataUtil {
    ...
    private static final Card Q_DIFFERENCE_BETWEEN_FRAMEWORK_LIBRARIES = new Card(
            ...
            new Answer("Libraries are meant to be used ‘as is’ while frameworks are meant to be customized/extended"),
            getTopicSet("CS2103T", "ComputerScience"));
    private static final Card Q_DIFFERENCE_BETWEEN_ASSOCIATION_DEPENDENCIES = new Card(
            new Question("What is the difference between an association and a dependency in a UML?"),
            new Answer("Association is a reference based relationship between 2 classes. A dependency is normally created when you receive a "
    ...
    private static final Card Q_DESIGN_PATTERN = new Card(
            ...
            new Answer("An elegant reusable solution to a commonly recurring problem with a given context in software design."),
            getTopicSet("CS2103T", "ComputerScience"));
    private static final Card Q_PURPOSE_OF_STAGING = new Card(
            new Question("What is the purpose of staging?"),
            new Answer("This intermediate step allows us to commit only some changes while saving other changes for a later commit."),
