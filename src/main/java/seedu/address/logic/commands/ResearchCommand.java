...
public class ResearchCommand extends Command {
    ...
    public static final String COMMAND_WORD = "research";
    ...
    public static final String MESSAGE_SELECT_CARD_SUCCESS = "Research Card: %1$s";

    private final Index targetIndex;

    public ResearchCommand(Index targetIndex) {
    ...
    public CommandResult execute(Model model, CommandHistory history) throws CommandException {
        ...
        Card cardToResearch = filteredCardList.get(targetIndex.getZeroBased());
        EventsCenter.getInstance().post(new DisplayResearchPageEvent(cardToResearch));
