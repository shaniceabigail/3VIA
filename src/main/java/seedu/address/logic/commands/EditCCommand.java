 ...
 */
public class EditCCommand extends Command {
     ...
     */
    public EditCCommand(Index index, EditCardDescriptor editCardDescriptor) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof EditCCommand)) {
            return false;
        }

        // state check
        EditCCommand e = (EditCCommand) other;
