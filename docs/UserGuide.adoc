...
=== Research on a question : `google`

Loads the Google search page for the question of the identified card. +
Format: `google INDEX`
...
bStart an open-ended test of a specified topic. In an open-ended test, the user will get the choose whether he/she has answered correctly by comparing their answers with the expected answer. +
