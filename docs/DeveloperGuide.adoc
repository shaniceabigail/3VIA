...
The contents of the each AppState, or the functionalities of that page is attached to the tab itself.
...
with dark text. The command will swap the current theme set to a "Dark Theme" stylesheet with each command created.
// end::ModeCommand[]
