...
|`* * *` |curious learner |be able to test my knowledge |be sure that I have memorised my content
...
[discrete]
=== Use case 1: Find more info on topic
...
* 3a. Time limit exceeded and user did not answer the question
[none]
** 3a1. System: Continue to next question at step 4.
+
