...
[caption = Day Mode, image::3VIATheme.png[width="800"]]
image::DarkTheme.png[width="800"]
==== GUI Handling
The default of the application is a "Day Themed" stylesheet, meaning a generally white background
with dark text. The command will swap the current theme set to a darker theme.
//end::ModeCommand[]
