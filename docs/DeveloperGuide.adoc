...
Step 4. Suppose the user chose to match a question to an answer, the system will then determine whether it is a correct match.
...
1. User: Adds question, answer and tag(s).
...
2. System: Displays list of questions with tag.
...
* 2a. Tag not found
[none]
** 2a1. System: Indicates tag not found.
+
Use case ends.
