...
=== Mode Feature
==== Current Implementation
Mode can be accessed as a command in any AppState of 3VIA, which allows you to toggle between day and night mode anywhere in the app.

==== GUI Handling
The command will swap the current theme
//end::ModeCommand[]
