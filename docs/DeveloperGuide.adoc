...
* **Alternative 1 (current choice):** Uses `TriviaTest`, `TriviaResultStorage` to accommodate the different testing feature in 3VIA.
** Pro:
...
* **Alternative 2:** Implement each kinds of test as a standalone test with its own standalone class and event handler.
** Pro:
