...
Step 1. The user enter the `testO` command and a new `OpenEndedTestCommand` will be created.
...
* `USER_INPUT` Will be the user's answer to the question. It can be a blank line.
* `IS_ANSWER_CORRECT` The user will indicate if the question was answered correctly.
...
===== UI related considerations during a OpenEndedTest
