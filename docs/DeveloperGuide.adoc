...
Step 4: Every card in the unique card list is checked against the existing list of cards in `TriviaBundle` for duplicates.

Step 5: The unique card list is then added into `TriviaBundle`. The number of cards, the cards imported are displayed to the user for verification. +

The sequence diagram below shows the import of multiple cards.
...
*** The `Format` class verifies the formatting of the text file, mark and display the errors with the text file within the application for editing.
