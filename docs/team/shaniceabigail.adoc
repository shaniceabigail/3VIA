...
<<<<<<< HEAD:docs/team/shaniceabigal.adoc
3VIA is a desktop application that can be used for learners to recap their subjects, through active recall. The app focuses on learning, testing and reviewing, to ensure that the user can go through an iteration, and have any resource they need.
=======
...
>>>>>>> update-documentations:docs/team/shaniceabigail.adoc
